...
def register_e3container(tenant_id,name,image_id,flavor_id,desc='',secret='e3secret',extra=''):
    '''
    @return container-uuid if successful, None otherwise
    '''
    session=E3COMPUTEDBSession()
    try:
        session.begin()
...
def start_e3container(container_id):
    ...
    try:
        ...
        session.close()
    pass
def stop_e3container(container_id):
    session=E3COMPUTEDBSession()
    try:
        session.begin()
        container=session.query(Container).filter(Container.id==container_id).first()
...
def unregister_e3container_pre(container_id):
    ...
    try:
        ...
        if not container:
            return False
        if container.task_status =='failed':
            unregister_e3container_post(container.id)
            return True
        if container.task_status != 'deployed':
            return False
        msg=dict()
...
if __name__=='__main__':
    ...
    #print(stop_e3container('e0c82a67-fd17-4447-9979-4544e09d94eb'))
    #print(start_e3container('e0c82a67-fd17-4447-9979-4544e09d94eb'))
    #print(unregister_e3container_pre('b4780cc6-8fd2-416b-b07c-b4c9648e6de9'))
    #print(unregister_e3container_pre('6f7c6f85-2900-4c6f-8c43-2f18318ea660'))
    #print(unregister_e3container_pre('6f7c6f85-2900-4c6f-8c43-2f18318ea660'))
    #print(unregister_e3container_pre('ad626ef0-96c3-405f-a16d-bcf4f496e2de'))
    print(start_e3container('ed436c0b-05f3-4e27-b07d-3a2f1b77eb41'))
    if False:
        print(register_e3container('2c90d294-34b0-43bd-8c95-d716f87f829f',
                        'meeeow\'s host',
                        image_id='9c1de662-c4a9-40d7-8d20-04eee4696e93',#image_id='c25416ce-72a7-415b-aa1a-9e3b365cded3',
                        flavor_id='75f806c3-150b-4fb8-92b5-192f072b6b57',#flavor_id='75f806c3-150b-4fb8-92b5-192f072b6b57',
