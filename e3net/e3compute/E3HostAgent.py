...
if __name__=='__main__':
    ...
    print(pull_image('centos7.lxc.vnf.image','127.0.0.1',key='e3net',force_pull=True))
    print(validate_image('centos7.lxc.vnf.image','af18f2920a4e725cabd0e25e9af3c910b209b69e'))
