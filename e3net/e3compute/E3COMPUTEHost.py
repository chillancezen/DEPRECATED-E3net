...
class Image(E3COMPUTEDBBase):
    ...
    sha1sum=Column(String(64),nullable=False)
...
def register_e3image(imagename,size,sha1sum,desc=''):
    session=E3COMPUTEDBSession()
    try:
        session.begin()
...
if __name__=='__main__':
    ...
    #print(register_e3image('centos7.lxc.vnf.image',22113223,sha1sum='af18f2920a4e725cabd0e25e9af3c910b209b69e',desc='special for virtual routing and forwarding'))
