...
from e3net.e3compute.E3Scheduler import e3scheduler_func
from e3net.e3compute.E3Scheduler import assign_host_side_mq 
if __name__=='__main__':
    ...
    hostmq=E3MQClient(queue_name=None,
                        user=e3cfg['rabbitmq']['rabbitmq_user'],
                        passwd=e3cfg['rabbitmq']['rabbitmq_passwd'],
                        host=e3cfg['rabbitmq']['rabbitmq_server_host'],
                        port=e3cfg['rabbitmq']['rabbitmq_server_port'])
    assign_host_side_mq(hostmq) 
